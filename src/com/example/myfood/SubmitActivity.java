...
public class SubmitActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		AEditText1 = (EditText) findViewById(R.id.tijiao_AeditText1);
		AEditText2 = (EditText) findViewById(R.id.tijiao_AeditText2);
		//AEditText3 = (EditText) findViewById(R.id.tijiao_AeditText3);
		BEditText1 = (EditText) findViewById(R.id.tijiao_BeditText1);
		BEditText2 = (EditText) findViewById(R.id.tijiao_BeditText2);
		CEditText1 = (EditText) findViewById(R.id.tijiao_CeditText1);
		CEditText2 = (EditText) findViewById(R.id.tijiao_CeditText2);
		DEditText1 = (EditText) findViewById(R.id.tijiao_DeditText1);
		button1 = (Button) findViewById(R.id.tijiao_button1);
		binddata();

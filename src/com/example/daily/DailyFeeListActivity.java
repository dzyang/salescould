...
public class DailyFeeListActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dailyfeelist);
		...
		button1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(DailyFeeListActivity.this, MainFragment.class);
	...
	private List<Map<String, Object>> getData() {
		 String url=myapplication1.getlocalhost()+ "/android/json_fee/list.php?companycode="+myapplication1.getCompanycode()+"&userid="+myapplication1.getUserid();
	    	list = new ArrayList<Map<String, Object>>();
	    	try {
				List<UserFee> bfjllist=jsonUserFee.getjsonlastarticles(url);
				for (UserFee UserFees : bfjllist) {
					HashMap<String, Object> item = new HashMap<String, Object>();
					item.put("title", UserFees.getProjectname());
	 ...
	 private void loadMoreDate() {
			...
			String url=myapplication1.getlocalhost()+ "/android/json_fee/list.php?companycode="+myapplication1.getCompanycode()+"&userid="+myapplication1.getUserid()+"&page="+count;
	    	list = new ArrayList<Map<String, Object>>();
	    	try {
	    		List<UserFee> bfjllist=jsonUserFee.getjsonlastarticles(url);
				for (UserFee UserFees : bfjllist) {

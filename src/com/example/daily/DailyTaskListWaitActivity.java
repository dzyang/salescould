...
public class DailyTaskListWaitActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dailytask_list_wait);
		...
		button1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(DailyTaskListWaitActivity.this, DailyTaskActivity.class);
	...
	private void initData() {
	 ...
	 private List<Map<String, Object>> getData() {
		 String url=myapplication1.getlocalhost()+ "/android/json_task/list.php?companycode="+myapplication1.getCompanycode()+"&userid="+myapplication1.getUserid()+"&status=0";
	 ...
	 private void loadMoreDate() {
			...
			String url=myapplication1.getlocalhost()+ "/android/json_task/list.php?companycode="+myapplication1.getCompanycode()+"&userid="+myapplication1.getUserid()+"&status=0&page="+count;
	    	list = new ArrayList<Map<String, Object>>();
	    	try {
	    		List<UserTask> bfjllist=jsonUserTask.getjsonlastarticles(url);
	    		for (UserTask UserTasks : bfjllist) {

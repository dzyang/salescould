...
public class DailyTaskListAllActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dailytask_list_all);
		...
		button1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(DailyTaskListAllActivity.this, DailyTaskActivity.class);

	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> l, View v, int position,
				...
				if(data.get(position).get("title").equals("新建任务"))
				{	
					Intent intent = new Intent();
					intent.setClass(DailyTaskActivity.this, DailyTaskNewActivity.class);
					startActivity(intent);
					finish();
				}else if(data.get(position).get("title").equals("待办任务"))
				{
					Intent intent = new Intent();
					intent.setClass(DailyTaskActivity.this, DailyTaskListWaitActivity.class);
					startActivity(intent);
					finish();					
				}else if(data.get(position).get("title").equals("已办任务"))
				{
					Intent intent = new Intent();
					intent.setClass(DailyTaskActivity.this, DailyTaskListFinshActivity.class);
					startActivity(intent);
					finish();					
				}else	if(data.get(position).get("title").equals("已交任务"))
				{
					Intent intent = new Intent();
					intent.setClass(DailyTaskActivity.this, DailyTaskListAllActivity.class);
					startActivity(intent);
					finish();		
				}
			}
		...
		button1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent();
				intent.setClass(DailyTaskActivity.this, MainFragment.class);
				startActivity(intent);
				finish();

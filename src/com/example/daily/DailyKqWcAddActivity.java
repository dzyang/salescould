...
public class DailyKqWcAddActivity extends Activity {
  ...
  //  ListView lv;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dailykq_wc_new);
		...
		button1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(DailyKqWcAddActivity.this, DailyKqWcActivity.class);
...
Runnable saveRun = new Runnable(){  
		...
		public void run() {  
			...
			int result;
			String target = myapplication1.getlocalhost()+ "/android/json_kq/wc_add.php";
			...
			EditText startdate_edit= (EditText) findViewById(R.id.dailykq_wc_startdate);
			paramsList.add(new BasicNameValuePair("_startdate",startdate_edit.getText().toString()));//工作ID
			
			EditText starttime__edit= (EditText) findViewById(R.id.dailykq_wc_starttime);
			paramsList.add(new BasicNameValuePair("_starttime",starttime__edit.getText().toString()));//完成日期
			
			EditText endtime__edit= (EditText) findViewById(R.id.dailykq_wc_endtime);
			paramsList.add(new BasicNameValuePair("_endtime",endtime__edit.getText().toString()));//完成目标
			
			EditText memo_edit= (EditText) findViewById(R.id.dailykq_wc_memo);
	 ...
	 Handler savehandler = new Handler(){
		    ...
		    public void handleMessage(Message msg) {
		        ...
		        if (result == 1) {
		        	...
		        	Toast.makeText(DailyKqWcAddActivity.this, "保存成功",Toast.LENGTH_SHORT).show();
					//finish();
				}else
				{
					Toast.makeText(DailyKqWcAddActivity.this, "保存失败",Toast.LENGTH_SHORT).show();
				}
		    }
		};

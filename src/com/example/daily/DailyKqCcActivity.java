...
public class DailyKqCcActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dailykq_cc);
		...
		button1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(DailyKqCcActivity.this, DailyKqActivity.class);
		...
		new AlertDialog.Builder(this)  
		               .setItems(states, new DialogInterface.OnClickListener() {  
		                   ...
		                   public void onClick(DialogInterface dialog, int which) {  
		                       ...
		                       case 0:  
			                    	  Intent intent = new Intent();
			           				intent.setClass(DailyKqCcActivity.this, DailyKqCcAddActivity.class);
			           				startActivity(intent);
			           				finish();
			           				overridePendingTransition(R.anim.in_from_right, R.anim.out_to_left);
		                           break;  
	...
	private void loadMoreDate() {
		...
		String url=myapplication1.getlocalhost()+ "/android/json_kq/cc_list.php?companycode="+myapplication1.getCompanycode()+"&userid="+myapplication1.getUserid()+"&page="+count;
    	list = new ArrayList<Map<String, Object>>();
    	try {
    		List<UserQcCc> bfjllist=jsonUserQcCc.getjsonlastarticles(url);
			for (UserQcCc UserQcCcs : bfjllist) {
				HashMap<String, Object> item = new HashMap<String, Object>();
				item.put("title", UserQcCcs.getMemo());
	 ...
	 private List<Map<String, Object>> getData() {
		 	String url=myapplication1.getlocalhost()+ "/android/json_kq/cc_list.php?companycode="+myapplication1.getCompanycode()+"&userid="+myapplication1.getUserid();
	    	list = new ArrayList<Map<String, Object>>();
	    	try {
				List<UserQcCc> bfjllist=jsonUserQcCc.getjsonlastarticles(url);
				for (UserQcCc UserQcCcs : bfjllist) {

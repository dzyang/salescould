...
public class DailyKqDkActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dailykq_dk);
		...
		button1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(DailyKqDkActivity.this, DailyKqActivity.class);
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> l, View v, int position,
				...
				if(data.get(position).get("title").equals("签到"))
				{	
					Intent intent = new Intent();
					...
					intent.setClass(DailyKqDkActivity.this, DailyKqDkMapActivity.class);
					startActivity(intent);
					finish();
				}else if(data.get(position).get("title").equals("早退"))
				{
					Intent intent = new Intent();
					Bundle arguments = new Bundle();
					arguments.putString("type","2");
					intent.putExtras(arguments);
